...
object ApiEndpointInventory {
    ...
    val ALL: List<Endpoint> = listOf(
        ...
        Endpoint("GET", "/api/v1/contests/{slug}/notices", Access.PUBLIC),
        Endpoint("GET", "/api/v1/contests/{slug}/questions", Access.PUBLIC),
        ...
        Endpoint("POST", "/api/v1/contests/{slug}/notices", Access.AUTHENTICATED),
        Endpoint("DELETE", "/api/v1/contests/{slug}/notices/{noticeId}", Access.AUTHENTICATED),
        Endpoint("POST", "/api/v1/contests/{slug}/questions", Access.AUTHENTICATED),
        Endpoint("PUT", "/api/v1/contests/{slug}/questions/{questionId}/answer", Access.AUTHENTICATED),
        Endpoint(
            "POST",
